...
if(isset($_GET['type']) && $_GET['type']!=''){
  $type=get_safe_value($link, $_GET['type']);
   if($type=='status'){
    ...
    $update_status_sql = "UPDATE cats SET status='$status' where id='$id' ";
    mysqli_query($link, $update_status_sql);
  }
  if($type=='delete'){
    $id = get_safe_value($link, $_GET['id']);
    $delete_sql = "DELETE FROM cats  where id='$id' ";
    mysqli_query($link, $delete_sql );
    $_SESSION['delete'] = "<div class='text-success'>Category deleted successfully.</div>";
    header("location: category.php");
  }else{
    $_SESSION['delete'] = "<div class='text-danger'>Category delete failed.</div>";
    header("location: category.php");
  }
}
...
<div class="mr-auto justify-content-center">
    <a href="../my_ecom/add_category.php" class="btn btn-primary" >Add Category</a>
    </div>
    <?php
    ...
    <div class="col-12 col-m-12 col-sm-12">
      <div class="card">
        <div class="card-header ">
          ...
          <a href="../my_ecom/add_category.php" ><i class="fas fa-ellipsis-h"></i></a>
            ...
            <td> <?php echo $i; ?> </td>
              ...
              ?> 
               ...
               <td>
                  ...
                  <a href="../my_ecom/update_cat.php?id=<?php echo $row['id'] ?>" class="btn btn-primary">Edit</a>&nbsp;
